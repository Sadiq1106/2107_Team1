...
df = pd.read_csv("static/csv/dailycoronadata.csv")
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(id='my_dropdown',
                     ...
                     value='Country',  # dropdown value selected automatically when page loads
...
def build_graph(column_chosen):
    ...
    fig.update_layout(title={'text': 'MADER SITANG CORONA',
